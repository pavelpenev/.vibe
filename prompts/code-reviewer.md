...
If the task includes pre-run verification results (e.g. `Verification results: ...` from a verifier agent), use them as the mechanical layer — do not re-run commands yourself.
