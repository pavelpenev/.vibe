...
ROLES: dict[str, dict] = {
    ...
    "generic-implementor": {
        ...
        "description": "Generic implementor on {model}; intent-based Python/JSON/YAML/MD/TOML file editing",
        "delegation_anchor": r"`generic-implementor`",
        "delegation_row": "| `{agent}` | JSON summary | Generic implementor on {model}; intent-based Python/JSON/YAML/MD/TOML file editing | Lisp files (use `lisp-implementor`) |",
        "agents_purpose": "Generic implementor ({model})",
    ...
    "lisp-implementor": {
        ...
        "description": "Lisp implementor on {model}; intent-based Lisp editing with form extraction for s-expression safety",
        "delegation_anchor": r"`lisp-implementor`",
        "delegation_row": "| `{agent}` | JSON summary | Lisp implementor on {model}; intent-based Lisp editing with form extraction for s-expression safety | Non-Lisp files (use `generic-implementor`) |",
        "agents_purpose": "Lisp implementor ({model})",
    ...
    "advisor": {
        ...
        "description": "Advisor on {model}; independent perspective on difficult decisions, architectural choices, and risky operations",
        "delegation_anchor": r"`advisor`",
        "delegation_row": "| `{agent}` | Markdown advice | Advisor on {model}; independent perspective on difficult decisions and risky operations | Routine work, execution, file modifications |",
        "agents_purpose": "Advisor ({model})",
